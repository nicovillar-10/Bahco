...
<!-- formularioooooooo -->
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Alta de nuevo tipo de evento <small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form name="nuevo_tipo_evento" id="registro" class="form-horizontal form-label-left" method="POST">
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12">Nuevo Tipo de Evento<span class="required">*</span></label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input name= "nuevo_tipo_evento"  value="" type="text" class="form-control" placeholder="Escriba el nuevo tipo de evento">
                        </div>
                      </div>
                      </form>
                      </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#enviar').click(function(){
            ...
            $.ajax({
                type:"POST",
                url:"php/registro_tipo_evento.php",
                data:datos,
                success:function(r){
                    if(r==1){
                        alert("Tipo de evento agregado con éxito");
                        window.location="http://localhost/proyecto_bahco/production/administrar_tipo_evento.php";
                    }else{
                        alert("Falló al intentar registrar un nuevo tipo de evento");
                    }
                }
            });
            return false;
