          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>ADMINISTRAR CATEGORIA </h3>
              </div>
            </div>
              <div class="clearfix"></div>
              <a href="nueva_categoria.php"><button class="btn btn-success" value="Nuevo" style="margin-left:90%" id="btnNuevo" name="btnNuevo">Nuevo</button></a>
...
function abrir (id){
  window.open('ver_categoria.php?id='+id,'modificar', 'height=400,width=400');
}
function eliminar(id){
    Swal.fire({
  title: 'Esta seguro?',
  text: "Estas por eliminar una categoría!",
  type: 'warning',
