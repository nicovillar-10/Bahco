          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>ADMINISTRAR SECTOR </h3>
              </div>
            </div>
              <div class="clearfix"></div>
              <a href="nuevo_sector.php"><button class="btn btn-success" value="Nuevo" style="margin-left:90%" id="btnNuevo" name="btnNuevo">Nuevo</button></a>
...
function abrir (id){
  window.open('ver_sector.php?id='+id,'modificar', 'height=400,width=400');
}
  ...
  if (result.value) {
     $.ajax({
                ...
                success:function(data){
                    ...
                    setTimeout("window.location = 'http://localhost/proyecto_bahco/production/administrar_sector.php'",2000);
                }
            });
  }
})           
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
    ...
    <script src="js/getSector.js"></script> 