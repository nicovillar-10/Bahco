...
<!-- formularioooooooo -->
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Alta de nueva categoria <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form name="nueva_categoria" id="registro" class="form-horizontal form-label-left" method="POST">
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12">Nueva Categoria<span class="required">*</span></label>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                          <input name= "nueva_categoria"  value="" type="text" class="form-control" placeholder="Escriba la nueva categoria">
                        </div>
                      </div>
                      </form>
                      </div>
            ...
            $.ajax({
                ...
                success:function(r){
                    if(r==1){
                        ...
                        window.location="http://localhost/proyecto_bahco/production/modificar_categoria.php";
                    }else{
                        alert("Falló al intentar registrar una nueva categoría");
                    }
                }
            });
            return false;
